...
export default function DashCompany() {
  ...
  return (
    <div className={`w-full shadow-inner  shadow-gray-700  md:mx-auto ${theme === "dark" ? "text-white bg-gray-800"  : "text-gray-800 bg-white "}w-full mt-30 shadow-inner rounded-2xl shadow-blue-200  md:mx-auto p-3 ` }
>
      {users.length > 0 ? (
        <>
          <TableContainer >
            <Table className={` ${theme === "dark" ? "text-white bg-gray-800 "  : "text-gray-800 bg-white "}` }>
              <TableHead>
                <TableRow>
                  ...
                  <TableCell sx={{ color: theme === "dark" ? "white" : "black" }}>Admin</TableCell>
              ...
              <TableBody>
                {users.map((user) => (
                  <TableRow key={user.id}>
                    ...
                    <TableCell>
                      {user.isAdmin ? <FaCheck className="text-green-500" /> : <FaTimes className="text-red-700" />}
                    </TableCell>
                    <TableCell sx={{ color: theme === "dark" ? "white" : "black" }}>
                      <span
                        onClick={() => {
